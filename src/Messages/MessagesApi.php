...
/** 16장 부록 — JSON API 공통 (public/api/messages/*.php) */
final class MessagesApi
{
    ...
    public static function assertContextKind(string $kind): void
    {
        if (!in_array($kind, ['student', 'study_room', 'tutor'], true)) {
            self::fail(422, 'validation', 'context_kind: student | study_room | tutor');
        }
    }
