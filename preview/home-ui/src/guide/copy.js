...
export const GUIDE_PAGES = {
  ...
  'saved-contact': {
    ...
    featureCards: [
      ...
      {
        title: '쪽지하기',
        body: '전화번호 공개 전 공식 쪽지 채널로 첫 연락을 시작할 수 있습니다.',
        icon: I.message,
      },
    ],
    conceptTable: [
    ...
    flow: [
      ...
      { label: '쪽지·마이페이지', caption: '첫 연락 또는 이어서 관리', icon: I.message },
    ],
    steps: [
      {
      ...
      {
        title: '결정이 가까워지면 쪽지 또는 마이페이지에서 이어가세요',
