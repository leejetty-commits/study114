...
const KEY = 'study114-preview-message-threads';
let nextId = 1;
  ...
  const threads = [
    {
      ...
      scopeBadge: '구조화 + paid_only',
      scopeHint: '요청문 visibility=paid_only',
      showRequestInPanel: true,
      requestSummary: '주 2회, 수학 집중, 대치동 희망',
      structuredLine: '중2 · 수학 · 예산 55만 · 대치동',
      lastPreview: '안녕하세요, 주 2회 가능합니다.',
      ...
      messages: [
        {
          id: 1,
          sender: 'peer',
          body: '안녕하세요, 주 2회 가능합니다. 대치동 방문도 가능합니다.',
