...
export const PRINCIPLES_POSITIVE = [
  ...
  { title: '공급자 제출자료 확인', body: '등록·제출자료·노출 상태를 직접 비교합니다. 플랫폼이 사실을 보증하지 않습니다.' },
...
export const GUIDE_ARTICLES = [
  ...
  },
  {
    ...
    checklist: [
      ...
      { label: '공급자 제출자료 직접 비교', hint: '제출자료·노출 상태는 본인이 확인 — 플랫폼이 보증하지 않음' },
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: '아닙니다. 공급자(공부방·과외)용 프라임/픽·쪽지권이며, 학부모 과외비 결제와 무관합니다.',
  },
  {
    q: '프라임/픽은 무엇인가요?',
