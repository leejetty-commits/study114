...
const STUDY_ROOM_SEED = [
  {
    study_room_name: '대치 우등생 공부방',
    location_label: '대치동 · 대치 래미안',
    latitude: 37.4965,
    longitude: 127.0602,
    main_subject_note: '수학·영어',
    grade_band: '중등',
    price_amount: 420000,
    slogan: '소규모로 깊게, 매일 성장이 보이는 공부방',
    intro_short: '소규모 밀착·학부모 리포트',
    intro_long:
      '한 타임 소인원으로 수업해 질문과 피드백이 끊기지 않습니다.\n주간 학습 리포트로 학부모님과 호흡을 맞추며, 자습과 수업을 같은 공간에서 이어 갑니다.',
    feature_1: '개별 피드백',
    feature_2: '자습 병행',
    feature_3: '주간 학부모 리포트',
    teaching_style: '꼼꼼함,개념중심',
    teaching_style_note: '개념을 먼저 잡고, 문제에서 빈틈을 메우는 방식입니다.',
    ...
    facility_summary: '냉난방·환기·CCTV',
    image_path: '/assets/listings/room-1.jpg',
    image_path_prime: '/assets/listings/room-1.jpg',
    gallery: ['/assets/listings/room-2.jpg', '/assets/listings/room-3.jpg'],
  ...
  {
    study_room_name: '스마트러닝 대치점',
    location_label: '대치동',
    latitude: 37.4938,
    longitude: 127.0648,
    main_subject_note: '국어·과학',
    grade_band: '초등',
    price_amount: 380000,
    slogan: '읽고 탐구하는 초등 루틴',
    intro_short: '창의 융합 중심 소그룹',
    intro_long: '독서와 실험을 하루 루틴에 녹여, 스스로 질문을 만드는 습관을 키웁니다.',
    feature_1: '실험 수업',
    feature_2: '독서 코칭',
    teaching_style: '친절함,기초부터',
    lesson_operation_type: 'time_slot_mixed_grade',
    career_years: 8,
    education_office_registered: true,
    weekend_available: false,
    one_on_one_available: false,
    lesson_place_type: 'office',
    capacity_per_time: '6~8명',
    facility_summary: '환기·주차',
    image_path: '/assets/listings/room-2.jpg',
    gallery: ['/assets/listings/room-1.jpg'],
    profile_status: 'published',
    compare_eligible: true,
  },
  {
    study_room_name: '맑은공부 대치센터',
    location_label: '대치동 · 빌라',
    latitude: 37.4952,
    longitude: 127.0589,
    main_subject_note: '영어 전문',
    grade_band: '중등 고등',
    price_amount: 450000,
    slogan: 'Speaking이 살아있는 영어 공간',
    intro_short: '영어 원어민 코치 상주',
    intro_long: '내신과 수능 독해를 기반으로, 말하기 루틴을 매일 짧게 이어 갑니다.',
    feature_1: 'Speaking 집중',
    feature_2: '내신+수능',
    feature_3: '원어민 코칭',
    teaching_style: '열정,해결중심',
    lesson_operation_type: 'group_by_time_slot',
    career_years: 15,
    education_office_registered: true,
    weekend_available: true,
    one_on_one_available: true,
    lesson_place_type: 'office',
    capacity_per_time: '5명',
    facility_summary: '냉난방·화장실',
    image_path: '/assets/listings/room-3.jpg',
    gallery: ['/assets/listings/room-1.jpg', '/assets/listings/room-2.jpg'],
    profile_status: 'published',
    compare_eligible: true,
  },
  ...
  { study_room_name: '새싹 공부방', location_label: '대치동', latitude: 37.4941, longitude: 127.0633, main_subject_note: '초등 종합', grade_band: '초등', price_amount: 320000, feature_1: '기초 학습', career_years: 6, education_office_registered: true, weekend_available: false, one_on_one_available: false, lesson_place_type: 'home', capacity_per_time: '3~4명', facility_summary: '—', profile_status: 'draft', compare_eligible: false },
  { study_room_name: '밝은미래 학원형', location_label: '도곡동', latitude: 37.4888, longitude: 127.0472, main_subject_note: '중등', grade_band: '중등', price_amount: 400000, feature_1: '내신 대비', career_years: 9, education_office_registered: true, weekend_available: true, one_on_one_available: false, lesson_place_type: 'office', capacity_per_time: '10명', facility_summary: '냉난방', profile_status: 'published', compare_eligible: true },
  { study_room_name: '하늘빛 공부방', location_label: '대치동', latitude: 37.4971, longitude: 127.0598, main_subject_note: '수학', grade_band: '중등', price_amount: 360000, feature_1: '문제풀이', career_years: 7, education_office_registered: false, weekend_available: true, one_on_one_available: true, lesson_place_type: 'office', capacity_per_time: '4명', facility_summary: '환기', profile_status: 'published', compare_eligible: true },
  { study_room_name: '온누리 스터디', location_label: '대치동', latitude: 37.4933, longitude: 127.0576, main_subject_note: '논술·국어', grade_band: '고등', price_amount: 330000, feature_1: '논술 첨삭', career_years: 11, education_office_registered: true, weekend_available: false, one_on_one_available: false, lesson_place_type: 'office', capacity_per_time: '6명', facility_summary: 'CCTV', profile_status: 'draft', compare_eligible: true },
  { study_room_name: '플러스 대치', location_label: '대치동', latitude: 37.4958, longitude: 127.0655, main_subject_note: '영어·수학', grade_band: '초등', price_amount: 390000, feature_1: '양과목 패키지', career_years: 4, education_office_registered: true, weekend_available: true, one_on_one_available: false, lesson_place_type: 'office', capacity_per_time: '5명', facility_summary: '주차', profile_status: 'published', compare_eligible: true },
  { study_room_name: '아이빌 공부방', location_label: '개포동', latitude: 37.4895, longitude: 127.0668, main_subject_note: '초등', grade_band: '초등', price_amount: 300000, feature_1: '돌봄+학습', career_years: 3, education_office_registered: false, weekend_available: true, one_on_one_available: false, lesson_place_type: 'home', capacity_per_time: '4명', facility_summary: '—', profile_status: 'hidden', compare_eligible: false },
  { study_room_name: '채움 학습실', location_label: '대치동', latitude: 37.4919, longitude: 127.0629, main_subject_note: '중·고 종합', grade_band: '고등', price_amount: 440000, feature_1: '자기주도', career_years: 10, education_office_registered: true, weekend_available: true, one_on_one_available: true, lesson_place_type: 'office', capacity_per_time: '12명', facility_summary: '냉난방·환기', profile_status: 'published', compare_eligible: true },
  { study_room_name: '해오름 공부방', location_label: '대치동', latitude: 37.4968, longitude: 127.0639, main_subject_note: '과학·수학', grade_band: '중등', price_amount: 370000, feature_1: '실험·개념', career_years: 6, education_office_registered: true, weekend_available: false, one_on_one_available: false, lesson_place_type: 'office', capacity_per_time: '6명', facility_summary: '환기', profile_status: 'published', compare_eligible: true },
  { study_room_name: '미래탐구소', location_label: '대치동', latitude: 37.4949, longitude: 127.0564, main_subject_note: '코딩·수학', grade_band: '중등 고등', price_amount: 480000, feature_1: '프로젝트', feature_2: '코딩대회', career_years: 5, education_office_registered: true, weekend_available: true, one_on_one_available: true, lesson_place_type: 'office', capacity_per_time: '5명', facility_summary: 'PC실', profile_status: 'published', compare_eligible: true },
];
