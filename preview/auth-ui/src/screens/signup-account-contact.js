...
export function renderSignupAccountContact() {
  const content = `
    <div class="panel">
      ...
      <form data-form="account-contact">
        <div class="form-group" data-email-wrap hidden>
          ...
          <p class="form-hint">로그인 ID이자 비밀번호 찾기 기준입니다.</p>
        </div>
        <div class="form-group">
          <label class="form-label form-label--required" for="account-phone">휴대폰</label>
          <input class="form-input" type="tel" id="account-phone" name="phone" placeholder="010-0000-0000" autocomplete="tel" required />
