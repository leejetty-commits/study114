...
const ROUTES = {
  ...
  '/signup/account-contact': 'signupAccountContact',
  '/signup/provider-identity': 'signupProviderIdentity',
...
const SCREEN_LABELS = {
  ...
  signupRole: '회원구분',
  signupForm: '가입폼',
  signupVerifyEmail: '이메일확인',
  signupAccountContact: '계정연락처',
  signupProviderIdentity: '본인인증',
  signupBasic: '기본등록',
  signupExtra: '추가입력',
  signupComplete: '가입완료',
  findId: '아이디찾기',
