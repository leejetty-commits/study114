...
import { renderSignupIdentity, bindSignupIdentityEvents } from './screens/signup-identity.js';
...
const SCREENS = {
  ...
  signupIdentity: { render: renderSignupIdentity, bind: bindSignupIdentityEvents },
